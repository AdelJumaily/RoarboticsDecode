...
public class RobotStateEstimator implements ISubsystem {
    ...
    public RobotStateEstimator(DCRobot ppRobot, BNO055IMU imu, Pose2d initialPose) {
        setSkystoneRobot(dcRobot);
        setImu(imu);
        setPose(initialPose);
    ...
    public DCRobot getSkystoneRobot() {
        return dcRobot;
    }


    public void setSkystoneRobot(DCRobot skystoneRobot) {
        this.dcRobot = skystoneRobot;
    }
